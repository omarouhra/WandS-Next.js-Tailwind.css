...
const ServiceData = [
  {
    id: 1,
    icon: <BeakerIcon className=' text-blue-dark' />,
    title: "Projects!",
    paragraph:
  ...
  {
    id: 2,
    icon: <AdjustmentsIcon className=' text-blue-dark' />,
    title: "Maitenance!",
    paragraph:
  ...
  {
    id: 3,
    icon: <NewspaperIcon className='text-blue-dark' />,
    title: "Consultants!",
    paragraph:
  ...
  {
    id: 4,
    icon: <DesktopComputerIcon className=' text-blue-dark' />,
  ...
  {
    id: 5,
    icon: <DeviceMobileIcon className=' text-blue-dark' />,
    title: "iOS & Android!",
    paragraph:
  ...
  {
    id: 6,
    icon: <SupportIcon className=' text-blue-dark' />,
